...
typename ttransform2<T, COLUMN_MAJOR>::self_t ttransform2<T, COLUMN_MAJOR>::translate(const tvec2<T> &offset) noexcept
{
    return self_t(mat_t::translate(offset), mat_t::translate(-offset));
}

template<typename T, bool COLUMN_MAJOR>
typename ttransform2<T, COLUMN_MAJOR>::self_t ttransform2<T, COLUMN_MAJOR>::translate(T x, T y) noexcept
{
    return self_t(mat_t::translate(x, y), mat_t::translate(-x, -y));
}

template<typename T, bool COLUMN_MAJOR>
typename ttransform2<T, COLUMN_MAJOR>::self_t ttransform2<T, COLUMN_MAJOR>::rotate(T rad) noexcept
{
    return self_t(mat_t::rotate_z(rad), mat_t::rotate_z(-rad));
}

template<typename T, bool COLUMN_MAJOR>
typename ttransform2<T, COLUMN_MAJOR>::self_t ttransform2<T, COLUMN_MAJOR>::scale(T x, T y) noexcept
{
    return self_t(mat_t::scale(x, y), mat_t::scale(1 / x, 1 / y));
}

template<typename T, bool COLUMN_MAJOR>
typename ttransform2<T, COLUMN_MAJOR>::self_t ttransform2<T, COLUMN_MAJOR>::scale(const tvec3<T> &ratio) noexcept
{
    return scale(ratio.x, ratio.y, ratio.z);
}

template<typename T, bool COLUMN_MAJOR>
typename ttransform2<T, COLUMN_MAJOR>::self_t ttransform2<T, COLUMN_MAJOR>::operator*=(const self_t &rhs) noexcept
{
    mat_ *= rhs.mat_;
    inv_ = rhs.inv_ * inv_;
    return *this;
...
template<typename T, bool COLUMN_MAJOR>
typename ttransform2<T, COLUMN_MAJOR>::self_t ttransform2<T, COLUMN_MAJOR>::inv() const noexcept
{
    return self_t(inv_, mat_);
}

template<typename T, bool COLUMN_MAJOR>
typename ttransform2<T, COLUMN_MAJOR>::self_t ttransform2<T, COLUMN_MAJOR>::inverse() const noexcept
{
    return inv();
}

template<typename T, bool COLUMN_MAJOR>
const typename ttransform2<T, COLUMN_MAJOR>::mat_t& ttransform2<T, COLUMN_MAJOR>::get_mat() const noexcept
{
    return mat_;
}

template<typename T, bool COLUMN_MAJOR>
const typename ttransform2<T, COLUMN_MAJOR>::mat_t& ttransform2<T, COLUMN_MAJOR>::get_inv_mat() const noexcept
{
    return inv_;
}
...
{
    return ttransform2<T>(lhs.get_mat() * rhs.get_mat(), rhs.get_inv_mat() * lhs.get_inv_mat());
}
