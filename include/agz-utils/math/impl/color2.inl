...
template<typename T>
typename tcolor2<T>::self_t tcolor2<T>::clamp(
...
template<typename T>
typename tcolor2<T>::self_t tcolor2<T>::clamp_low(
...
template<typename T>
typename tcolor2<T>::self_t tcolor2<T>::clamp_high(
...
template<typename T>
typename tcolor2<T>::self_t &tcolor2<T>::operator+=(
