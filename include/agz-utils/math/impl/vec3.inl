...
template<typename T>
typename tvec3<T>::self_t tvec3<T>::clamp(
...
template<typename T>
typename tvec3<T>::self_t tvec3<T>::clamp_low(
...
template<typename T>
typename tvec3<T>::self_t tvec3<T>::clamp_high(
...
template<typename T>
typename tvec3<T>::self_t &tvec3<T>::operator+=(
