...
AGZ_MATH_API ttransform2<T, C>::ttransform2() noexcept
...
template<typename T, bool C>
AGZ_MATH_API ttransform2<T, C>::ttransform2(const mat_t &m) noexcept
    : ttransform2(m, m.inv())
{
...
template<typename T, bool C>
AGZ_MATH_API ttransform2<T, C>::ttransform2(
...
template<typename T, bool C>
AGZ_MATH_API ttransform2<T, C>::ttransform2(uninitialized_t) noexcept
...
AGZ_MATH_API typename ttransform2<T, COLUMN_MAJOR>::self_t
...
template<typename T, bool COLUMN_MAJOR>
AGZ_MATH_API tvec2<T> ttransform2<T, COLUMN_MAJOR>::apply_to_point(
...
template<typename T, bool COLUMN_MAJOR>
AGZ_MATH_API tvec2<T> ttransform2<T, COLUMN_MAJOR>::apply_to_vector(
...
template<typename T, bool COLUMN_MAJOR>
AGZ_MATH_API tvec2<T> ttransform2<T, COLUMN_MAJOR>::apply_to_normal(
...
template<typename T, bool COLUMN_MAJOR>
AGZ_MATH_API tvec2<T> ttransform2<T, COLUMN_MAJOR>::apply_inverse_to_point(
    const tvec2<T> &point) const noexcept
{
...
template<typename T, bool COLUMN_MAJOR>
AGZ_MATH_API tvec2<T> ttransform2<T, COLUMN_MAJOR>::apply_inverse_to_vector(
    const tvec2<T> &vector) const noexcept
{
...
template<typename T, bool COLUMN_MAJOR>
AGZ_MATH_API tvec2<T> ttransform2<T, COLUMN_MAJOR>::apply_inverse_to_normal(
    const tvec2<T> &normal) const noexcept
{
...
template<typename T, bool COLUMN_MAJOR>
AGZ_MATH_API const typename ttransform2<T, COLUMN_MAJOR>::mat_t&
...
template<typename T, bool COLUMN_MAJOR>
AGZ_MATH_API bool ttransform2<T, COLUMN_MAJOR>::operator==(
