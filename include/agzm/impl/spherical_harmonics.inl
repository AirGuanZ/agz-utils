...
#define DEFINE_SH(L, M, COEF, EXPR) \
    ...
    { \
        ...
        { \
            [[maybe_unused]] constexpr T pi = agzm::PI<T>; \
...
namespace spherical_harmonics
{
    ...
    sh_func_t<T> *linear_table() noexcept
    {
        ...
        {
            &agzm::spherical_harmonics::eval<0, 0, T>,

            &agzm::spherical_harmonics::eval<1, -1, T>,
            &agzm::spherical_harmonics::eval<1, 0, T>,
            &agzm::spherical_harmonics::eval<1, 1, T>,

            &agzm::spherical_harmonics::eval<2, -2, T>,
            &agzm::spherical_harmonics::eval<2, -1, T>,
            &agzm::spherical_harmonics::eval<2, 0, T>,
            &agzm::spherical_harmonics::eval<2, 1, T>,
            &agzm::spherical_harmonics::eval<2, 2, T>,

            &agzm::spherical_harmonics::eval<3, -3, T>,
            &agzm::spherical_harmonics::eval<3, -2, T>,
            &agzm::spherical_harmonics::eval<3, -1, T>,
            &agzm::spherical_harmonics::eval<3, 0, T>,
            &agzm::spherical_harmonics::eval<3, 1, T>,
            &agzm::spherical_harmonics::eval<3, 2, T>,
            &agzm::spherical_harmonics::eval<3, 3, T>,

            &agzm::spherical_harmonics::eval<4, -4, T>,
            &agzm::spherical_harmonics::eval<4, -3, T>,
            &agzm::spherical_harmonics::eval<4, -2, T>,
            &agzm::spherical_harmonics::eval<4, -1, T>,
            &agzm::spherical_harmonics::eval<4, 0, T>,
            &agzm::spherical_harmonics::eval<4, 1, T>,
            &agzm::spherical_harmonics::eval<4, 2, T>,
            &agzm::spherical_harmonics::eval<4, 3, T>,
            &agzm::spherical_harmonics::eval<4, 4, T>,
