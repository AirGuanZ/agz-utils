...
/** @brief 将灰度图输出到jpg文件 */
void save_gray_to_jpg_file(const std::string &filename, const math::tensor_t<math::byte, 2> &data);

/** @brief 将灰度 + alpha图输出到jpg文件 */
void save_gray_alpha_to_jpg_file(const std::string &filename, const math::color2b *data, int w, int h);
/** @brief 将灰度 + alpha图输出到jpg文件 */
void save_gray_alpha_to_jpg_file(const std::string &filename, const math::tensor_t<math::color2b, 2> &data);

/** @brief 将rgb图像输出到jpg文件 */
void save_rgb_to_jpg_file(const std::string &filename, const math::color3b *data, int w, int h);
/** @brief 将rgb图像输出到jpg文件 */
void save_rgb_to_jpg_file(const std::string &filename, const math::tensor_t<math::color3b, 2> &data);
